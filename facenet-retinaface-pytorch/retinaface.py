...
class Retinaface(object):
    _defaults = {
        ...
        #   retinaface训练完的权值路径
        # ----------------------------------------------------------------------#
        "retinaface_model_path": 'model_data/Epoch25-Retinaface.pth',
        # ----------------------------------------------------------------------#
        ...
        #   facenet训练完的权值路径
        # ----------------------------------------------------------------------#
        "facenet_model_path": 'model_data/facenet_mobilenet.pth',   #'model_data/facenet_mobilenet.pth',
        # ----------------------------------------------------------------------#
    ...
    def generate(self):
        ...
        pretrained_dict = torch.load(self.facenet_model_path, map_location=torch.device('cpu'))
        ...
        self.facenet.load_state_dict(model_dict,strict=False)
    ...
    def detect_image(self, image):
        ...
        for i, b in enumerate(boxes_conf_landms):
            text = "confidence:{:.4f}".format(b[4])+'  distance:{:.4f}'.format(min_distance)
            print(text)
            b = list(map(int, b))
            # ---------------------------------------------------#
